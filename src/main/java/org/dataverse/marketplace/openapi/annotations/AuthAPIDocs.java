...
public @interface AuthAPIDocs {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200",
                        description = "Registration status successfully retrieved",
                        content = @Content(mediaType = "application/json",
                        schema = @Schema(implementation = Object.class),
                        examples = @ExampleObject(value = "{\"enabled\": true}"))),
        @ApiResponse(responseCode = "500",
                        description = "Internal Server Error during registration status retrieval",
                        content = @Content(mediaType = "application/json",
                        schema = @Schema(implementation = ServerMessageResponse.class),
                        examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE)))
    })
    @Operation(summary = "Gets the current registration status.",
                description = "This public endpoint returns whether public user registration is currently enabled.")
    public @interface GetRegistrationStatus{}
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200",
                        ...
                        examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
        @ApiResponse(responseCode = "400",
                        description = "Bad request on registration status update",
                        content = @Content(mediaType = "application/json",
                        schema = @Schema(implementation = ServerMessageResponse.class),
                        examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
        @ApiResponse(responseCode = "401",
                        ...
                        examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
        @ApiResponse(responseCode = "500",
                        description = "Internal Server Error during registration status update",
                        content = @Content(mediaType = "application/json",
                        schema = @Schema(implementation = ServerMessageResponse.class),
                        examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE)))
    })
    @Operation(summary = "Sets the registration status (Admin only).",
                description = "This endpoint allows administrators to enable or disable public user registration.")
    @Parameter(name = "enabled",
                description = "Whether to enable or disable public registration",
                required = true,
                in = ParameterIn.QUERY,
                schema = @Schema(type = "boolean"),
                example = "true")
    public @interface SetRegistrationStatus{}

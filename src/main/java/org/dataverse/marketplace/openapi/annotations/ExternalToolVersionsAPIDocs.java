...
public @interface ExternalToolVersionsAPIDocs {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "New Manifest successfully added to the version of the external tool", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
            @ApiResponse(responseCode = "400", description = "Bad request when adding a new manifest", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
            @ApiResponse(responseCode = "401", description = "Bad credentials when adding a new manifest", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
            @ApiResponse(responseCode = "500", description = "Internal Server Error when adding a new manifest", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE)))
    })
    @Operation(summary = "Adds a new manifest.", description = "This endpoint will add a new manifest to the specified version of the external tool.")
    @Parameter(name = "toolId", description = "The id of the external tool that contains the version to add a new manifest", required = true, in = ParameterIn.PATH, schema = @Schema(type = "integer"))
    @Parameter(name = "versionId", description = "The id of the version of the external tool that will have a new manifest", required = true, in = ParameterIn.PATH, schema = @Schema(type = "integer"))
    ...
    @Tag(name = "External Tools Version Manifest")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Version manifest successfully retrieved", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ExternalToolManifestDTO[].class), examples = @ExampleObject(ExternalToolVersionSamples.EXTERNAL_TOOL_VERSION_MANIFESTS_SAMPLE))),
            @ApiResponse(responseCode = "400", description = "Bad request when retrieving the manifest", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
            @ApiResponse(responseCode = "401", description = "Bad credentials when retrieving the manifest", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
            @ApiResponse(responseCode = "500", description = "Internal Server Error when retrieving the manifest", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE)))
    })
    @Operation(summary = "Retrieves the manifest.", description = "This endpoint will retrieve the specified manifest from the specified version of the external tool.")
    @Parameter(name = "toolId", description = "The id of the external tool that contains the version to get the manifest", required = true, in = ParameterIn.PATH, schema = @Schema(type = "integer"))
    @Parameter(name = "versionId", description = "The id of the version of the external tool to retrieve the manifest", required = true, in = ParameterIn.PATH, schema = @Schema(type = "integer"))
    @Parameter(name = "manifestId", description = "The id of the manifest to be retrieved", required = true, in = ParameterIn.PATH, schema = @Schema(type = "integer"))
    ...
    @Operation(summary = "Updates the manifest.", description = """
            This endpoint will update the specified manifest from the specified version of the external tool.
            """)
    ...
    @Tag(name = "External Tools Version Manifest")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Manifest successfully deleted from the version of the external tool", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
            @ApiResponse(responseCode = "400", description = "Bad request when trying to delete the manifest", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
            @ApiResponse(responseCode = "401", description = "Bad credentials when when trying to delete the manifest", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE))),
            @ApiResponse(responseCode = "500", description = "Internal Server Error when when trying to delete the manifest", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMessageResponse.class), examples = @ExampleObject(GenericBusinessSamples.SERVER_MESSAGE_RESPONSE)))
    })
    @Operation(summary = "Deletes the manifest.", description = """

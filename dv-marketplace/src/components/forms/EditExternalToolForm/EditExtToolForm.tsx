            ...
            <ul>
                ...
                {tool?.versions.map((version, index) => (
                    <li key={index}>
                        ...
                        <Link to={`/edit/${tool?.id}/versions/`} className='btn btn-primary bi-pen px-0'><span/></Link>
                        <a href={version.id} className='btn btn-primary bi-pen px-0'><span/></a>
                        <a href={version.id} className='btn btn-danger bi-trash px-0'><span/></a>
                    </li>
                ))}

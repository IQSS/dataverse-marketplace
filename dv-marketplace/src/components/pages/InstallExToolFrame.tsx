...
function InstallExToolFrame({manifest, showModal, setShowModal} : {manifest?: Manifest | undefined, 
    showModal?: boolean,
    ...
    <Modal show={showModal} onHide={handleClose} size="lg" centered>
        ...
        <Modal.Body>   
            <Alert variant="info" className="text-center">
                ...
                &nbsp; Your API key will be only sent to the specified Dataverse instance.
                </span>                 
            </Alert>         
            <div id="installFrame" >
                <div className="container">
                    ...
                    <form encType="multipart/form-data" id="installForm">
                        ...
                        <button type="button" className="btn btn-primary bi-download"
                        onClick={() => sendData(manifest)}> Install </button>
